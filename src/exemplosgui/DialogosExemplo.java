...
public class DialogosExemplo extends JFrame {
    public DialogosExemplo() {
        ...
        btnMensagem.addActionListener(e ->
                JOptionPane.showMessageDialog(this, "Olá, aluno! 👋", "Mensagem", JOptionPane.INFORMATION_MESSAGE)
        );
        ...
        btnOpcoes.addActionListener(e -> {
            ...
            int idx = JOptionPane.showOptionDialog(this, "Escolha um curso:", "Cursos",
                    JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, cursos, cursos[0]);
            JOptionPane.showMessageDialog(this, "Selecionado: " + (idx >= 0 ? cursos[idx] : "nada"));
        });
